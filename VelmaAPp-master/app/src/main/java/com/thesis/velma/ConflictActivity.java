...
public class ConflictActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog a_build = new AlertDialog.Builder(context)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Intent inn = new Intent(ConflictActivity.this, DateListView.class);
                        startActivity(inn);
                    }
                })
        ...
        Log.i("Event Ac1", ""+newdate);
        Toast.makeText(context, "Date Selected" + newdate, Toast.LENGTH_SHORT).show();
        Intent newIn = getIntent();
        String name = newIn.getStringExtra("name");
        String desc = newIn.getStringExtra("desc");
        String ds = newIn.getStringExtra("ds");
        String de = newIn.getStringExtra("de");

        event.setText(name);
        descrip.setText(desc);
//        OnboardingFragment2_1.dateStart.setText(ds);
//        OnboardingFragment2_1.dateEnd.setText(de);


        Log.i("Event Act2", name +" " + desc+ " "+ ds + " "+ de);
